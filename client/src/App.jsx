...
import DevProfile from "./Pages/DevProfile/DevProfile.jsx";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route
          path="/addChat"
          element={userData ? <AddFriend /> : <Navigate to="/login" />}
        />
        <Route
          path="/myProfile"
          element={userData ? <UserProfile /> : <Navigate to="/login" />}
        />
        <Route
          path="/logout"
          element={userData ? <Logout /> : <Navigate to="/login" />}
        />
        <Route
          path="/community"
          element={userData ? <GroupChat /> : <Navigate to="/login" />}
        />
